...
// 配送员管理 配送员列表
export const MC_CHANGE_QUERYDATA = 'MC_CHANGE_QUERYDATA';
export const MC_CHANGE_DATA = 'MC_CHANGE_DATA';
export const MC_CHANGE_DATA_TOTAL = 'MC_CHANGE_DATA_TOTAL';
export const MC_CHANGE_SELECTEDROWKEYS = 'MC_CHANGE_SELECTEDROWKEYS';
